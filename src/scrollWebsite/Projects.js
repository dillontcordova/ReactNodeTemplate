...
import ParallaxNode from '../lib/ParallaxNode';
...
class Projects extends Component {
    ...
    render() {
        return (
            <div ref={this.getTrigger}>
                <ParallaxNode parent="#projects" imageSrc="http://genkoreanbbq.com/wp-content/uploads/2015/05/mainpic_b2.jpg"/>
